...
void chanprog()
{
  ...
  /* One-shot: add the IP form of FQDN-only bot link masks (hub has the
   * authoritative userfile here). Leaves do this when their userfile
   * arrives (see irc_userfile_ready). */
  heal_link_hosts();
}
